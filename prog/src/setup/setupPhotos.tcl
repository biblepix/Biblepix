...
#Create title
label .photosF.l1 -textvar msg::f6Tit -font bpfont3 -justify left
...
button .photosF.mainf.right.bar.open -width 30 -textvar msg::f6Find -height 1 -command {set fileJList [doOpen $DesktopPicturesDir .photosC]}
...
button .addBtn -textvar msg::f6Add -activebackground lightgreen -command {addPic $::picPath}
